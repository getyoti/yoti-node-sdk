...
import YotiAccountWatchlistCaSearchConfigResponse = require('./yoti.account.watchlist.ca.search.config.response');
...
export default WatchlistAdvancedCaSummaryResponse;
