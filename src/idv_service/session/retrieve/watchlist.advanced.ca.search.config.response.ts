...
import { WITH_YOTI_ACCOUNT, WITH_CUSTOM_ACCOUNT } from '../../idv.constants';
import WatchlistSearchConfigResponse = require('./watchlist.search.config.response');
import SearchProfileSourcesResponse = require('./search.profile.sources.response');
import TypeListSourcesResponse = require('./type.list.sources.response');
...
import ExactMatchingStrategyResponse = require('./exact.matching.strategy.response');
import FuzzyMatchingStrategyResponse = require('./fuzzy.matching.strategy.response');
...
export default WatchlistAdvancedCaSearchConfigResponse;
