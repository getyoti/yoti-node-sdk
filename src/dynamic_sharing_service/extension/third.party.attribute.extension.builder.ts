...
import ThirdPartyAttributeExtensionContent = require('./third.party.attribute.extension.content');
import AttributeDefinition = require('../../data_type/attribute.definition');
...
export default ThirdPartyAttributeExtensionBuilder;
