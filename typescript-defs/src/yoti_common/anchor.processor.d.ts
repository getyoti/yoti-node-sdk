...
export class AnchorProcessor {
     ...
     * @returns {YotiAnchor}
     */
    static getAnchorFromCerts(certificatesList: any[], signedTimestamp: YotiSignedTimeStamp, originServerCerts: any[], subType: string): YotiAnchor;
    /**
     ...
     * @returns {Object.<string, YotiAnchor[]>}
     */
    static getAnchorsByCertificate(certArrayBuffer: any, subType: string, signedTimestamp: YotiSignedTimeStamp, originServerCerts: any[]): {
        [x: string]: YotiAnchor[];
    };
    /**
     ...
     */
    static getAnchorByOid(extensionsData: any[], subType: string, signedTimestamp: YotiSignedTimeStamp, originServerCerts: any[], oid: string): YotiAnchor | null;
    /**
     * Return Anchor value.
     *
     * @deprecated no longer in use.
     ...
     */
    static processSignedTimeStamp(signedTimestampByteBuffer: any): YotiSignedTimeStamp;
    /**
     ...
     * @returns {Certificate[]}
     */
    static convertCertsListToX509(certificatesList: any[]): any[];
    /**
     ...
     * @returns {Certificate}
     */
    static convertCertToX509(certArrayBuffer: any): any;
    /**
