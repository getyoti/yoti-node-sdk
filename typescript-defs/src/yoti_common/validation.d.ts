...
declare class Validation {
     ...
     * @throws {TypeError}
     */
    static isString(value: any, name: string, optional?: any): void;
    /**
     * @param {*} value
     * @param {string} name
     * @param {bool} optional the value can be undefined
     ...
     * @throws {TypeError}
     */
    static isBoolean(value: any, name: string, optional?: any): void;
    /**
     * @param {Object} value
     * @param {string} name
     *
     ...
     * @throws {TypeError}
     */
    static isInteger(value: any, name: string, optional?: any): void;
    /**
     * @param {*} value
     * @param {string} name
     *
