...
const YotiAccountWatchlistCaSearchConfigResponse = require('../../../../src/doc_scan_service/session/retrieve/yoti.account.watchlist.ca.search.config.response');
const CustomAccountWatchlistCaSearchConfigResponse = require('../../../../src/doc_scan_service/session/retrieve/custom.account.watchlist.ca.search.config.response');
const WatchlistSummaryResponse = require('../../../../src/doc_scan_service/session/retrieve/watchlist.summary.response');
const WatchlistAdvancedCaSummaryResponse = require('../../../../src/doc_scan_service/session/retrieve/watchlist.advanced.ca.summary.response');
