...
const WatchlistScreeningSummaryResponse = require('../../../../src/doc_scan_service/session/retrieve/watchlist.screening.summary.response');
const WatchlistReportResponse = require('../../../../src/doc_scan_service/session/retrieve/watchlist.report.response');
const WatchlistScreeningReportResponse = require('../../../../src/doc_scan_service/session/retrieve/watchlist.screening.report.response');
