...
const {
  DigitalIdentityBuilders: { ThirdPartyAttributeExtensionBuilder },
} = require('../../..');
const ThirdPartyAttributeExtensionContent = require('../../../src/digital_identity_service/extension/third.party.attribute.extension.content');
