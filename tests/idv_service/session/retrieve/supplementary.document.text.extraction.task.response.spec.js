...
const GeneratedSupplementaryDocumentTextDataCheckResponse = require('../../../../src/idv_service/session/retrieve/generated.supplementary.document.text.data.check.response');
const SupplementaryDocumentTextExtractionTaskResponse = require('../../../../src/idv_service/session/retrieve/supplementary.document.text.extraction.task.response');
const GeneratedCheckResponse = require('../../../../src/idv_service/session/retrieve/generated.check.response');
